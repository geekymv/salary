	...
	<div id="wizard">
		...
		<div class="items">
			<div class="page">
               ...
               <p><label>学号：</label><input type="text" class="input" id="user" name="student.number" /></p>
               <p><label>登录密码：</label><input type="password" class="input" id="pass" name="student.password" /></p>
               <p><label>确认密码：</label><input type="password" class="input" id="repassword" name="repassword" /></p>
               <p><label>姓名：</label><input type="text" class="input" id="user" name="student.name" /></p>
			   <p><label>性别：</label>
