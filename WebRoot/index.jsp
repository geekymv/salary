	...
	<div id="wizard">
		...
		<div class="items">
			<div class="page">
               ...
               <p><label>学号：</label><input type="text" class="input" id="user" name="number" /></p>
               <p><label>登录密码：</label><input type="password" class="input" id="pass" name="password" /></p>
               <p><label>确认密码：</label><input type="password" class="input" id="repassword" name="repassword" /></p>
               <p><label>姓名：</label><input type="text" class="input" id="user" name="name" /></p>
			   <p><label>性别：</label>
			...
			<div class="page">
               ...
               <p><label>学院</label><input type="text" class="input" name="college" /></p>
               <p><label>专业</label><input type="text" class="input" name="profession" /></p>
